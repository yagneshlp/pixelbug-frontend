                        ...
                        <div className="program_detail_wrap">
                            <div className="single_propram">
                                <div className="inner_wrap">
                                    ...
                                    <div className="thumb wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                                        <img src="https://pixelbug-website.s3.ap-south-1.amazonaws.com/timeline/1.jpg" alt=""/>
                                    </div>                                    
                                </div>
                            </div>
                            <div className="single_propram">
                                <div className="inner_wrap">
                                    ...
                                    <div className="thumb wow fadeInRight" data-wow-duration="1s" data-wow-delay=".5s">
                                        <img src="https://pixelbug-website.s3.ap-south-1.amazonaws.com/timeline/2.jpg" alt=""/>
                                    </div>                                    
                                </div>
                            </div>
                            <div className="single_propram">
                            ...
                            <div className="single_propram">
                                <div className="inner_wrap">
                                    ...
                                    <div className="thumb  wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                                        <img src="https://pixelbug-website.s3.ap-south-1.amazonaws.com/timeline/4.jpg" alt=""/>
                                    </div>                                    
                                </div>
                            </div>
                            <div className="single_propram">
                                <div className="inner_wrap">
                                    ...
                                    <div className="thumb wow fadeInRight" data-wow-duration="1s" data-wow-delay=".5s">
                                        <img src="https://pixelbug-website.s3.ap-south-1.amazonaws.com/timeline/5.jpg" alt=""/>
                                    </div>                                   
                                </div>
                            </div>
                            <div className="single_propram">
                                <div className="inner_wrap">
                                    ...
                                    <div className="thumb  wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                                        <img src="https://pixelbug-website.s3.ap-south-1.amazonaws.com/timeline/6.jpg" alt=""/>
                                    </div>                                   
                                </div>
                            </div>
                            <div className="single_propram">
                                <div className="inner_wrap">
                                    <div className="circle_img"></div>
                                    <div className="porgram_top">
                                        <span className="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s">Aurora'17</span>
                                        <h4 className="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".4s">Feb 18, 2017</h4>
                                    </div>
                                    <div className="thumb wow fadeInRight" data-wow-duration="1s" data-wow-delay=".5s">
                                        <img src="https://pixelbug-website.s3.ap-south-1.amazonaws.com/timeline/7.jpg" alt=""/>
                                    </div>
                            ...
                            <div className="single_propram">
                                <div className="inner_wrap">
                                    ...
                                    <div className="thumb wow fadeInRight" data-wow-duration="1s" data-wow-delay=".5s">
                                        <img src="https://pixelbug-website.s3.ap-south-1.amazonaws.com/timeline/8.jpg" alt=""/>
                                    </div>
                            ...
                            <div className="single_propram">
                                <div className="inner_wrap">
                                    <div className="circle_img"></div>
                                    <div className="porgram_top">
                                        <span className=" wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s">Edit my raw</span>
                                        <h4 className=" wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">Dec 18, 2019</h4>
                                    </div>
                                    <div className="thumb  wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                                        <img src="https://pixelbug-website.s3.ap-south-1.amazonaws.com/timeline/9.jpg" alt=""/>
                                    </div>
                            ...
                            <div className="single_propram">
                                <div className="inner_wrap">
                                    ...
                                    <div className="thumb  wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                                        <img src="https://pixelbug-website.s3.ap-south-1.amazonaws.com/timeline/10.jpg" alt=""/>
                                    </div>
                            ...
                            <div className="single_propram">
                                <div className="inner_wrap">
                                    <div className="circle_img"></div>
                                    <div className="porgram_top">
                                        <span className="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s">Aurora'20</span>
                                        <h4 className="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".4s">Feb 1, 2020</h4>
                                    </div>
                                    <div className="thumb wow fadeInRight" data-wow-duration="1s" data-wow-delay=".5s">
                                        <img src="https://pixelbug-website.s3.ap-south-1.amazonaws.com/timeline/11.jpg" alt=""/>
                                    </div>
                            ...
                            <div className="single_propram">
                                <div className="inner_wrap">
                                    ...
                                    <div className="thumb  wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                                        <img src="https://pixelbug-website.s3.ap-south-1.amazonaws.com/timeline/12.jpg" alt=""/>
                                    </div>
